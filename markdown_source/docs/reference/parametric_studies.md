...
Before you can download measures from BCL, you will need an API key. Follow the instructions in the [Getting Started section](../getting_started/getting_started.md#installation-instructions) to get your key.
