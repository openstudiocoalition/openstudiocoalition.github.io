...
You can start your workflow using the [VirtualPULSE](https://virtualpulse.buildsci.us/) workflow, and then bring in models from selected buildings into OpenStudio. At that point they are like any other OpenStudio models.
