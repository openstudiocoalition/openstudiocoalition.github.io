...
The [Building Component Library](https://bcl.nlr.gov/) is one of the most powerful and time saving features associated with OpenStudio. Users can simply drag and drop BCL retrofit measures into a model to create quick and replicable analysis.<br><br>
